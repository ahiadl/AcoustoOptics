...
acquisitionLength_sec = 50e-6;

% TODO: Select the number of samples in each DMA buffer
samplesPerBufferPerChannel = 131072;
...
bufferDataOut = zeros(buffersPerAcquisition, samplesPerBuffer);
...
while ~captureDone
    ...
    if bufferFull
        ...
        bufferDataOut(buffersCompleted, :) = bufferOut.Value;
