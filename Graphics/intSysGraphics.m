classdef intSysGraphics < Graphics
    ...
    methods (Static)
        ...
        function figs  = createGraphicsVars()
            ...
            figs.intExt        = 'int';
            figsNames          = intSysGraphics.getGraphicsNames();
        ...
        function vars  = createOwnerVars()
            ...
            vars = intSysGraphics.createUserVars();
            vars.grid = [];
    ...
    methods
        function this = intSysGraphics()
            this@Graphics()
            
            this.figsNames = this.getGraphicsNames();
            this.numOfFigs = length(this.figsNames);
            
            this.figs     = intSysGraphics.createGraphicsVars();
            
            this.uVars    = intSysGraphics.createOwnerVars();
